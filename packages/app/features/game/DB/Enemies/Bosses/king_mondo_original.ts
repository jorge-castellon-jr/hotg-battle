...
const machine_king: BaseEnemyCard = {
  name: 'MACHINE KING',
  type: 'passive',
  text: 'While this card is in play, each time a Ranger rolls dice for an attack, remove 1 die from that attack and place 1 hit token on this card.',
  health: 6,
}
